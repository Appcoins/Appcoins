...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Appcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
     {"server1-aw", "54.226.196.78"},
    {"server2-i", "192.64.83.27"},
    {"server3-a", "120.145.149.109"},
    {"server4-t", "162.250.125.26"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"appcointools.com", "testnet-seed.appcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Appcoin is probably already running."), addrBind.ToString().c_str());
        else
